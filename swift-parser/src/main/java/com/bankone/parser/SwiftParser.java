...
public class SwiftParser {
    ...
    public String parse(File swiftFile, String processedDirPath) {
        try {
            ...
            if (swiftMessage.getBlock1() == null || swiftMessage.getBlock2() == null || swiftMessage.getType() == null) {
            ...
            throw new RuntimeException("Failed to parse file: " + swiftFile.getName(), e);
        }
    }
